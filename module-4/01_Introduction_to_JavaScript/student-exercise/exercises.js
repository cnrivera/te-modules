...
function lastDigit (x, y){
	...
	let strOfY = y.toString();
	
	if(strOfX.substr(strOfX.length-1, 1) === strOfY.substr(strOfY.length-1,1)) {
		return true;
	}
...
function cigarParty (cigarCount, isWeekend) {
	...
	else if (cigarCount >= 40 && cigarCount <= 60) {
		isSuccessfulParty = true;
	}

	return isSuccessfulParty;
}
