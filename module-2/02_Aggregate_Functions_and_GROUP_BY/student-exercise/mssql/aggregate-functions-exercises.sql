...
SELECT SUM(population) AS 'population_China'
FROM city
...
SELECT AVG(population) AS 'average_population_china'
FROM city
WHERE countrycode = 'CHN'

-- 13. The surface area of each continent ordered from highest to lowest.
-- (largest continental surface area: 31881000, "Asia")
SELECT SUM(surfacearea) AS 'largest_continental_surface_area', continent
FROM country
GROUP BY continent
...
SELECT COUNT(continent) AS 'country_count', continent
FROM country
GROUP BY continent
...
SELECT AVG(lifeexpectancy) AS average_lifeexpectancy, MIN(lifeexpectancy) AS min_lifeexpectancy, MAX(lifeexpectancy) AS max_lifeexpectancy, continent
FROM country
WHERE lifeexpectancy IS NOT NULL
GROUP BY continent
ORDER BY average_lifeexpectancy ASC
